...
spinThresh = 15   # Force at which we spin out
engineForce = 5   # Power of the engine
frictionForce = 10    # Scales track friction
sph = sphere(texture = "clouds.jpg", size = -500)
...
def gameOver(model, var):
    model.position = P3(51, 36, 0)
    model.velocity = P3(0,0,0)
    text("Demo concluded.", color = darkGreen)
...
track.placeObj(questionBlock, position = P3(51, 35, sin(time * 4) / 64 + .05), score = 102213, reaction = gameOver, duration = 10000000, sound = "good.mp3" )
track.placeObj(questionBlock, position = P3(51, 36, sin(time * 4) / 64 + .05), score = 102213, reaction = gameOver, duration = 10000000, sound = "good.mp3" )
track.placeObj(questionBlock, position = P3(51, 37, sin(time * 4) / 64 + .05), score = 102213, reaction = gameOver, duration = 10000000, sound = "good.mp3" )

rectangle(P3(58, 38.49, 0), P3(59.5, 38.49, 0), P3(58, 38.49, 1), texture = "opengl.jpg")
