...
world.color = black
(center, r) = slicePicture( "pics/an2.jpg", 4, 4, size = 2)
def blast(p, v):
...
def stage2(p, v):
    (c1, r1) = slicePicture( "pics/an1.jpg", 6, 6, size = 1.5, position = P3(-1.8, 0, 0))
    (c2, r2) = slicePicture( "pics/an3.jpg", 6, 6, size = 1.5, position = P3(1.8, 0, 0))
